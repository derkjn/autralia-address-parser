...
(function() {
  ...
  function lazyInit() {
    ...
    MatchedAddress.address = XRegExp(
      ...
      [^\\w\\#]*                                        \n\
      (" +
        MatchedAddress.streetNameNumber +
        ")\\W*                       \n\
      (?:" +
        MatchedAddress.fraction +
        "\\W*)?                  \n\
         " +
        MatchedAddress.streetName +
        "\\W+                      \n\
    ...
    MatchedAddress.informal_address = XRegExp(
      ...
      (?:" +
        ...
        "                            \n\
      (?:" +
        MatchedAddress.sec_unit.replace(/_\d/g, "$&1") +
        sep +
        ")?  \n\
      (?:" +
        MatchedAddress.place +
    ...
    MatchedAddress.intersection = XRegExp(
      ...
      ^\\W*                                                 \n\
      " +
        MatchedAddress.streetName.replace(/_\d/g, "1$&") +
        "\\W*?      \n\
      \\s+" +
        MatchedAddress.corner +
        "\\s+                         \n\
      " +
        MatchedAddress.streetName.replace(/_\d/g, "2$&") +
        "\\W+     \n\
      " +
        MatchedAddress.place +
        "\\W*$",
  ...
  parser.normalize_address = function(parts) {
    ...
    if (typeof parsed.streetType !== "undefined")
      parsed.streetType = shortenStreetType(parsed.streetType);
    if (typeof parsed.streetType1 !== "undefined")
      parsed.streetType1 = shortenStreetType(parsed.streetType1);
    if (typeof parsed.streetType2 !== "undefined")
      parsed.streetType2 = shortenStreetType(parsed.streetType2);
  ...
  function shortenStreetType(streetType) {
    ...
    //   console.log(s);
    // })
    if (typeof Street_Type[streetType] !== "undefined")
      return Street_Type[streetType];
    return streetType;
  }
